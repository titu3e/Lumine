...
import telegram
from Lumine import WHITELIST_USERS, dispatcher
...
from Lumine.modules.helper_funcs.string_handling import split_quotes
from Lumine.modules.log_channel import loggable
from Lumine.modules.sql import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # Lumine's sticker
        keyboard = None
        log_reason = (
